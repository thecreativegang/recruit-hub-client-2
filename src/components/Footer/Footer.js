...
const Footer = () => {
    ...
    return (
        <div>
            ...
            <footer class="footer p-10 bg-white-200 text-info-content">
   <div>
  ...
  <div>
    <span class="footer-title text-xl">Links</span> 
    <a class="link link-hover">Latest News & Blog</a> 
    <a class="link link-hover">Popular Services</a> 
  ...
  <div>
    ...
    <div class="form-control w-80">
      ...
      <div class="relative">
        <input type="text" placeholder="Email Address" class="input input-bordered w-full pr-16" /> 
...
<footer class="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
  <div class="items-center grid-flow-col">
    ...
    <p>RECRUIT HUB <br/> © {today.getFullYear()} All rights reserved</p>
  </div> 
