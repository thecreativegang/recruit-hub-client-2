            ...
            <div className=' h-full w-[95%] md:w-[75%] mx-auto '>
                <section className='grid grid-cols-1 md:grid-cols-2 gap-2  h-full mx-auto '>
                    ...
                    <div className=' flex justify-center items-center'>
                        <div>
                            <h1 className="md:text-[75px] text-[40px] leading-[60px] md:leading-[92px] font-bold text-[#1C2880] mb-[35px] dark:text-[#E2E8F0]">Get <span className='dark:text-[#38BDF8] text-[#3878DF]'>talent</span> , Get <span className='dark:text-[#38BDF8] text-[#3878DF]'>job</span> Recruiter Hub</h1>
                            ...
                            <div>
                                ...
                                <button onClick={() => navigateDeveloper('/register/developer')} className='  btn-primary-vlue2 dark:bg-[#0284C7] text-white ml-[25px]'>Get a job <i class="fa-solid fa-angle-right ml-[6px]"></i></button>
