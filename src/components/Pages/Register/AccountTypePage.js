  ...
  return (
    <div className="h-[100vh] ">
      <div className="flex justify-center  justify-items-center mt-20">
        <div className="card  md:w-1/5 w-full bg-base-100 shadow-xl h-fit">
          <div className="card-body ">
            ...
            <div className={`flex flex-col gap-5 mt-10 ${errorStyle}`}>
              <div
                onClick={() => handleBgColor('developer')}
                className={` border-zinc-400 p-2 text-xl text-center rounded-lg ${selectedOptionDev} cursor-pointer`}
              >
                <p>Join As a Developer</p>
              </div>
              <div
                onClick={() => handleBgColor('recruiter')}
                className={` border-zinc-400 p-2 rounded-lg ${selectedOptionRecruiter} text-xl text-center  cursor-pointer`}
              >
