...
const Register = () => {
    ...
    const onSubmit = async (data) => {
        ...
        axios.post(`https://team-muslim-forum-26437.herokuapp.com/check-username`)
    ...
    const handleUserNameValidation = async (username) => {
        ...
        username !== ''
            ?
            await axios.post(`https://team-muslim-forum-26437.herokuapp.com/check-username/${username || ''}`)
                .then(data => {
                    console.log(data)
