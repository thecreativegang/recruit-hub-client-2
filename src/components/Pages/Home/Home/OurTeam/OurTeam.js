...
const OurTeam = () => {
  ...
  <div className="hero-content flex-col lg:flex-row-reverse">
    <img src="https://i.ibb.co/17y5Fxd/contact-1.jpg" className="max-w-sm rounded-full shadow-2xl" />
    <div>
      <h1 className="text-7xl font-bold">Have Any on <span className='text-slate-400'>Project</span>  Mind! <span className='text-slate-400'>Contact</span>  Us</h1>
      ...
      <p className='text-2xl font-bold'>+88012 (345) 67 89</p>
        ...
        {/* input fields */}
      <input type="text" placeholder="Full Name" className="input input-bordered w-full max-w-xs mx-5" />
      <input type="text" placeholder="Email Address" className="input input-bordered w-full max-w-xs mx-5" />
      <br />
      <textarea className="textarea textarea-bordered w-full max-w-2xl mx-5 my-5" placeholder="Write message"></textarea>
      <br />
      <button className="btn btn-primary mx-5">Send Us Message</button>
    </div>
  </div>
</div>
            </div>
