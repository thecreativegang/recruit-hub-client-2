                                ...
                                <form onSubmit={handleSubmit(onSubmit)}>
                                    <div className="card-body">
                                        ...
                                        <div className="form-control mb-">
                                            <label className="label">
                                                <span className="label-text font-semibold dark:text-[#8C9BB6] text-[#334155]">Choose a username</span>
                                            </label>
                                            <input
                                    ...
                                    dark:bg-[#1E293B] dark:text-white dark:outline-0"
                                            ...
                                            <div className='text-md flex  justify-between mt-4  md:items-center xs:flex-col-reverse'>
                                                <div >
                                                    <button className="label-text font-semibold dark:text-[#8C9BB6] text-[#334155]" onClick={() => setPasswordBar(makeId(10))}>Suggest a Strong Password</button>
                                                </div>
                                                <div className='text-xl flex justify-end'>
                                                    <div className="form-control ">
                                                        <label className="label cursor-pointer  ">
                                                            <div className='flex justify-around gap-2 items-center '>
                                                                <p className="label-text font-semibold dark:text-[#8C9BB6] text-[#334155]">Show Password</p>
                                        ...
                                        <div className='mt-4 flex justify-between items-center'>
                                            {
                                                loading
                                                    ?
                                                    <button className="bg-[#0F172A] dark:bg-[#0284C7] font-bold btn-login text-white  uppercase">Register</button>
                                                    :
                                                    <button className="bg-[#0F172A] dark:bg-[#0284C7] font-bold btn-login text-white  uppercase">Register</button>

                                            }
                                            <label>
                                                <Link to="/login" className="label-text pointer font-semibold dark:text-[#8C9BB6] text-[#334155]">Already have an account? Login
                                                </Link>
                                            </label>
                                        </div>
