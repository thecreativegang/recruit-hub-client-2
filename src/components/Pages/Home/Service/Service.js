        ...
        <div className='py-16  dark:bg-[#0b1120]'>
            <div className='flex justify-center '>
                <div className='text-center'>
                    <h1 className='section-tittle relative color-blue-dark font-semibold inline-block dark:text-[#38BDF8] '>Service</h1>
                    <h1 className='text-[37px] md:text-[55px] leading-[45px]  md:leading-[60px] mb-[15px] font-semibold heading-color dark:text-[#E2E8F0]'>Creative Design Solutions</h1>
            ...
            <div className='md:w-[80%] w-[95%] mx-auto mt-8'>
                <div className='grid grid-cols-1 gap-8 md:grid-cols-3'>
                    <div className='service-item transition-all duration-500'>
                        <i className="fa-solid mb-[15px] fa-code-compare text-[75px] color-blue-dark dark:text-[#38BDF8]"></i>
                        <div>
                            <h1 className='text-[24px] heading-color font-semibold mb-[15px] dark:text-[#E2E8F0]'>Strategy</h1>
                            <ul className='text-[18px] mb-4'>
                                <li className='dark:text-[#8C9BB6]'><Link to="/" className="fa-solid mr-[12px] fa-arrow-right dark:text-[#38BDF8]"></Link>Product Management</li>
                                <li className='dark:text-[#8C9BB6]'><Link to="/" className="fa-solid mr-[12px] fa-arrow-right dark:text-[#38BDF8]"></Link>MVP Definition</li>
                                <li className='dark:text-[#8C9BB6]'><Link to="/" className="fa-solid mr-[12px] fa-arrow-right dark:text-[#38BDF8]"></Link>Product Strategy</li>
                            </ul>
                    ...
                    <div className='service-item transition-all duration-500'>
                        <i className="fa-solid mb-[15px] fa-database text-[75px] color-blue-dark dark:text-[#38BDF8]"></i>
                        <div>
                    ...
                    <div className='service-item transition-all duration-500'>
                        <i className="fa-solid mb-[15px] fa-code text-[75px] color-blue-dark dark:text-[#38BDF8]"></i>
                        <div>
