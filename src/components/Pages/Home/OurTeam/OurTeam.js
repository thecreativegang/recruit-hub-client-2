  ...
  return (
    <div className='my-20 '>
      <div className='text-center'>
        ...
        <h1 className='text-5xl font-bold text-black'>Experience Team Members</h1>
      ...
      {/* Contact us section */}
      <div>
        <div className="hero min-h-screen bg-base-100 my-20 bg-white">
          <div className="hero-content w-full flex-col lg:flex-row-reverse">
            <img src="https://i.ibb.co/17y5Fxd/contact-1.jpg" className="max-w-sm w-full rounded-full shadow-2xl" alt='' />
            <div>
              <h1 className="md:text-7xl text-3xl font-bold text-black">Have Any on <span className='text-slate-400'>Project</span>  Mind! <span className='text-slate-400'>Contact</span>  Us</h1>
              <p className="py-6 text-black">Sed ut perspiciatis unde omnis iste natus error voluptatem accusantium doloremque laudan tium, totam rem aperiam, eaque ipsa quae abillo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem</p>
              ...
              <div className='grid grid-cols-1 gap-y-10 md:grid-cols-2 mx-4 my-10'>
                <div>
                  ...
                  <p className='text-2xl font-bold text-black'>support@gmail.com</p>
                </div>

                <div>
                  <h3 className='text-primary text-xl k'>Phone Us</h3>
                  <p className='text-2xl font-bold text-black'>+88012 (345) 67 89</p>
                </div>

              </div>
              {/* input fields */}
              <input type="text" placeholder="Full Name" className="input input-bordered w-full max-w-xs mb-5 md:mx-2  bg-white" />
              <input type="text" placeholder="Email Address" className="input input-bordered w-full max-w-xs bg-white " />
              <br />
              <textarea className="textarea textarea-bordered w-full max-w-2xl   my-5 bg-white" placeholder="Write message"></textarea>
              <br />
