                    ...
                    <div className='my-10'>
                        ...
                        <div className='w-full md:w-[732px] p-6 rounded-lg mt-4 mx-auto bg-white'>
                            ...
                            <div className='w-full pt-2 pr-4  mb-5'>
                                ...
                                <form onSubmit={handleSubmit(onSubmit)}>
                                    <select {...register("gender")} className='border-2 rounded-md mt-1 px-2 py-2 text-base w-1/2'>
                                        {/* <option selected="selected" value="">Select an option</option> */}
                                        <option selected value="Select your education level">Select your education level</option>
                                        <option value="hsc">High School</option>
                                        <option value="u-bs">Unfinished Bachelor's degree</option>
                                    ...
                                    <div>
                                        ...
                                        <div className='w-full pt-2 pr-4  mb-5'>
                                            ...
                                            <form onSubmit={handleSubmit(onSubmit)} >
                                                ...
                                                <select {...register("gender")} className='border-2 rounded-md mt-1 px-2 py-2 text-base w-full mt-2'>
                                                    <option selected value="Select your education level">Select your education level</option>
                                                    <option value="hsc">High School</option>
                                                    <option value="u-bs">Unfinished Bachelor's degree</option>
                                                </select>
