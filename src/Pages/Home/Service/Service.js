        ...
        <div className='pb-16'>
            ...
            <div className='md:w-[80%] w-[95%] mx-auto mt-8'>
                <div className='grid grid-cols-1 gap-8 md:grid-cols-3'>
                    ...
                    >
                        ...
                        <div>
                            ...
                            <ul className='text-[18px] mb-4'>
                                <li><i class="fa-solid mr-[12px] fa-arrow-right"></i>Product Management</li>
                                <li><i class="fa-solid mr-[12px] fa-arrow-right"></i>MVP Definition</li>
                                <li><i class="fa-solid mr-[12px] fa-arrow-right"></i>Product Strategy</li>
                            </ul>
                            <a className='color-blue-dark font-bold text-[18px] underline' href="#">Read More <i class="fa-solid ml-[6px] fa-arrow-right-long"></i></a>
                        </div>
                    </div>
                    <div className='service-item'>
                        <i class="fa-solid mb-[15px] fa-database text-[75px] color-blue-dark"></i>
                        <div>
                    ...
                    <div className='service-item'>
                        <i class="fa-solid mb-[15px] fa-code text-[75px] color-blue-dark"></i>
                        <div>
